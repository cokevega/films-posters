...
const requestApi = async(id) => {
    return new Promise(
        (resolve, reject) => {
            fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=63ef1f636936271497c9d9693f2f1fa8&language=en-US`, {
                    method: 'GET'
                })
...
let config = {
    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjc1OTcsInByb2plY3RJZCI6MTU1NjIsInJvbGUiOjMsImlhdCI6MTYyMDYzNTA4NX0.tAi-Ild8tP9d9mo5qNXAVvn6laPWj7FEJN31BEfwUY8",
